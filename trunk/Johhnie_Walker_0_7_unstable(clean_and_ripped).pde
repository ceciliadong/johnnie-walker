...
int MOTORLEFT_REVERSE_SPEED[] =  {128, 135, 142, 149, 156, 163, 170, 177, 184, 191}; //128-191
int MOTORRIGHT_REVERSE_SPEED[] = {  1,   8,  15,  22,  29,  36,  43,  50,  57,  63}; //1-63
...
void turnLeft() { setMotorSpeed(4, 6); }
void turnRight() { setMotorSpeed(6, 4); }
...
int sensorPins[] = {A7, 8, A3, A4, A5, A6};
int sensorValues[6];
...
void getSensorValues() {
  for(int i = 0; i < 6; i++) sensorValues[i] = analogRead(sensorPins[i]); 
}
