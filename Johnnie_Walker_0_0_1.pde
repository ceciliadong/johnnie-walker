...
const int ULTRASONIC_SENSOR_TOTAL = 7;
int ultrasonicSensorPins[ULTRASONIC_SENSOR_TOTAL] = {30, 31, 32, 33, 34, 35, 36}; 
int ultrasonicSensorValues[ULTRASONIC_SENSOR_TOTAL] = {0, 0, 0, 0, 0, 0, 0};
...
void joystickControl() {
  ...
  int xDir = x > 50 ? 1 : -1;
  // base speed
  int temp = (maxSpeed - 5) * yDir * (abs(y-50) > 10);
  int basev = temp * (y - 50) / 50;
  // turn factor
